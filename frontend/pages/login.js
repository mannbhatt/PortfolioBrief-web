...
export default function Home() {
    ...
    async function handleGoogleSignin() {
        console.log('Login Google Click');
        ...
        <>
            <section className="h-screen flex items-center">
                <div className='w-96 mx-auto flex flex-col gap-10 text-center px-8 md:p-0'>
                    <h2 className='text-4xl font-black'>Login to PortfolioBrief</h2>
                    <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                        <div className="input-button">
                            <button type='button' onClick={handleGoogleSignin} className={`w-full border py-3 flex justify-center items-center gap-2 hover:bg-gray-200 rounded-lg h-14 transition-all duration-300 active:scale-95`}>
                        ...
                        <div className='relative'>
                            ...
                            <span className='text-gray-600 bg-white px-2 z-10'>or Log In with Email</span>
                        </div>
                        ...
                        <div className="input-button">
                            <button type='submit' className={`w-full bg-cyan-500 hover:bg-cyan-600 rounded-md py-3 text-gray-50 text-lg font-semibold h-14 transition-all duration-300 active:scale-95`}>Login</button>
                        </div>
                    </form>
                    <p className='text-center text-gray-400 '>
                        not registered yet?
                        <span className='relative group inline-block leading-[200%] mx-1'>
                            <a href='/register' className='font-semibold text-cyan-500'>Sign Up</a>
